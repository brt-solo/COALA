...
model_info = {
    "mlp_model": f"~/MAP-CF/synthetic/mlp_model_{suffix}.pth",
    #"nn_model": f"~/MAP-CF/synthetic/synthetic_{suffix}.pth",
    "hgb_model": f"~/MAP-CF/synthetic/hgboost_model_{suffix}.pkl",
    #"linear_model": f"~/MAP-CF/synthetic/linear_model_{suffix}.pkl",
    "random_forest": f"~/MAP-CF/synthetic/random_forest_model_{suffix}.pkl"
...
for model_name, model_path in model_info.items():
    ...
    # Save archive
    archive_filename = f"archives/dataset_3/{model_name}_archive_{suffix}_large_pop.pkl"
